...
func makeFakeClient(objects ...*unstructured.Unstructured) dynamic.Interface {
	...
	s.AddKnownTypeWithName(
		schema.GroupVersionKind{Group: "nightjar.io", Version: "v1alpha1", Kind: "ConstraintReport"},
		&unstructured.Unstructured{},
	)
	s.AddKnownTypeWithName(
		schema.GroupVersionKind{Group: "nightjar.io", Version: "v1alpha1", Kind: "ConstraintReportList"},
