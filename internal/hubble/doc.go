...
//   - nightjar_hubble_connected (gauge): 1 if connected, 0 if disconnected
//   - nightjar_hubble_flow_drops_total (counter, labels: namespace): Total flow drops observed
//   - nightjar_hubble_reconnects_total (counter): Total reconnection attempts
package hubble
