...
// This is the primary data source for agents consuming Nightjar events.
...
// BuildEvent creates a corev1.Event with all Nightjar annotations populated.
