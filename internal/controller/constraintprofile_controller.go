// Package controller implements Kubernetes controllers for Nightjar-owned CRDs.
//
...
// it watches Nightjar's own typed CRDs (not external unstructured objects).
package controller
...
import (
	...
	"github.com/nightjarctl/nightjar/internal/discovery"
)
