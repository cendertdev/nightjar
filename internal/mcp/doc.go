...
// # Resources
//
//	nightjar://reports/{namespace}      → full ConstraintReport as JSON
//	nightjar://constraints/{ns}/{name}  → single constraint detail
//	nightjar://health                   → operational health
//	nightjar://capabilities             → what this instance can do
//
// # Constructor
//
