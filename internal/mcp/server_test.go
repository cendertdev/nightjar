...
func TestHandlers_Query_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/tools/nightjar_query", bytes.NewReader([]byte("not json")))
	w := httptest.NewRecorder()
...
func TestHandlers_Explain_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/tools/nightjar_explain", bytes.NewReader([]byte("{bad")))
	w := httptest.NewRecorder()
...
func TestHandlers_Check_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/tools/nightjar_check", bytes.NewReader([]byte("{bad")))
	w := httptest.NewRecorder()
...
func TestHandlers_Remediation_InvalidJSON(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/tools/nightjar_remediation", bytes.NewReader([]byte("bad")))
	w := httptest.NewRecorder()
