...
spec:
  ...
  platformAdminIdentification:
    ...
    # namespaceAnnotation: "nightjar.io/admin-team"
```
...
For external channels (Slack), the notification dispatcher checks the recipient's scope before rendering the message. Platform admin channels receive full detail; developer channels receive summary detail.
