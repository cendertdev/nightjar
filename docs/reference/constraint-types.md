...
Nightjar normalizes all policy types into a common constraint model. Each constraint has a `type` field that classifies what kind of restriction it represents.
