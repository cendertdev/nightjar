...
Technical reference documentation for Nightjar.
{: .fs-6 .fw-300 }
...
|----------|-----------------|
| ConstraintReport | `nightjar.io/v1alpha1` |
| ConstraintProfile | `nightjar.io/v1alpha1` |
| NotificationPolicy | `nightjar.io/v1alpha1` |
| MCP Schema | `1` |
...
|--------|------|-------------|
| `nightjar_constraints_total` | Gauge | Total constraints |
| `nightjar_constraints_by_type` | Gauge | By constraint type |
| `nightjar_constraints_by_severity` | Gauge | By severity |
| `nightjar_adapter_parse_errors` | Counter | Parse failures |
| `nightjar_notifications_sent` | Counter | By channel |
