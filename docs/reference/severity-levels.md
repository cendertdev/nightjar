...
### CLI Output
```bash
$ nightjar query -n my-namespace --severity Warning
...
### CLI Output
```bash
$ nightjar query -n my-namespace --severity Info
...
The `nightjar status` command shows severity breakdown:
...
3. Use `nightjar explain` to diagnose
