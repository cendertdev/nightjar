...
Or via HTTP:
```bash
curl http://nightjar-controller:8090/resources/reports/production
```
...
Or via HTTP:
```bash
curl http://nightjar-controller:8090/resources/constraints/production/restrict-egress
```
...
Or via HTTP:
```bash
curl http://nightjar-controller:8090/resources/health
```
...
Or via HTTP:
```bash
curl http://nightjar-controller:8090/resources/capabilities
```
